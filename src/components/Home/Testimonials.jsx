...
const testimonials = [
    {
        review: 'This product changed our workflow completely!',
        company: 'TechCorp',
        subtitle: 'CEO',
        stars: 5,
    },
    ...
    {
        review: 'Highly recommend this to all startups.',
        company: 'StartupX',
        subtitle: 'Founder',
        stars: 5,
    },
    ...
    {
        review: 'Outstanding quality and support.',
        company: 'NextGen',
        subtitle: 'CTO',
        stars: 5,
    },
...
const TestimonialCarousel = () => {
    ...
    const handleNext = () => {
        ...
        setCurrentIndex((prev) =>
            Math.min(prev + 1, testimonials.length - cardsPerView)
        );
    };
    ...
    const stopDrag = () => {
        ...
        setCurrentIndex(
            Math.min(Math.max(newIndex, 0), testimonials.length - cardsPerView)
        );
    };
        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-10">
            ...
            ${
                ...
                <div
                    ...
                    className="flex overflow-hidden cursor-grab py-2"
